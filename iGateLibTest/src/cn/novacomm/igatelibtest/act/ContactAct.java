...
public class ContactAct extends BaseActivity {
    ...
    protected void findViews() {
        ...
        lv=(ListView) findViewById(R.id.fragment_contact_list);
        quickAlphabeticBar=(QuickAlphabeticBar) findViewById(R.id.fast_scroller);
        tv_fast_position=(TextView) findViewById(R.id.fast_position);
...
//                  }
    ...
    private void setAdapter(List<ContactBean> list) {
        adapter = new ContactHomeAdapter(this, list, quickAlphabeticBar);
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent =new Intent(ContactAct.this, MessageBoxList.class);
